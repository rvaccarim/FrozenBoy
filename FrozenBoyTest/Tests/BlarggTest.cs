...
namespace FrozenBoyTest
{
    public class BlarggTest(ITestOutputHelper output)
    {
        ...
        public void TestCPU_01() {
            bool passed = Test(@"01-special.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_02() {
            bool passed = Test(@"02-interrupts.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_03() {
            bool passed = Test(@"03-op sp,hl.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_04() {
            bool passed = Test(@"04-op r,imm.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_05() {
            bool passed = Test(@"05-op rp.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_06() {
            bool passed = Test(@"06-ld r,r.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_07() {
            bool passed = Test(@"07-jr,jp,call,ret,rst.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_08() {
            bool passed = Test(@"08-misc instrs.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_09() {
            bool passed = Test(@"09-op r,r.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_10() {
            bool passed = Test(@"10-bit ops.gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }

        [Fact]
        public void TestCPU_11() {
            bool passed = Test(@"11-op a,(hl).gb", Config.CPU_Path, logExecution: false, testOutput: TestOutput.LinkPort);
            Assert.True(passed);
        }
