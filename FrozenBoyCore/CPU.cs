    ...
    public class CPU {
        ...
        private void InitializePrefixed() {
            cb_opcodes = new Dictionary<byte, Opcode> {
                ...
                { 0x40, new Opcode(0x40, "BIT 0, B",             2,  8, () => { BIT(0, regs.B); })},
                { 0x41, new Opcode(0x41, "BIT 0, C",             2,  8, () => { BIT(0, regs.C); })},
                { 0x42, new Opcode(0x42, "BIT 0, D",             2,  8, () => { BIT(0, regs.D); })},
                { 0x43, new Opcode(0x43, "BIT 0, E",             2,  8, () => { BIT(0, regs.E); })},
                { 0x44, new Opcode(0x44, "BIT 0, H",             2,  8, () => { BIT(0, regs.H); })},
                { 0x45, new Opcode(0x45, "BIT 0, L",             2,  8, () => { BIT(0, regs.L); })},
                { 0x46, new Opcode(0x46, "BIT 0, (HL)",          2, 12, () => { BIT(0, mem.Read8(regs.HL)); })},
                { 0x47, new Opcode(0x47, "BIT 0, A",             2,  8, () => { BIT(0, regs.A); })},
                { 0x48, new Opcode(0x48, "BIT 1, B",             2,  8, () => { BIT(1, regs.B); })},
                { 0x49, new Opcode(0x49, "BIT 1, C",             2,  8, () => { BIT(1, regs.C); })},
                { 0x4A, new Opcode(0x4A, "BIT 1, D",             2,  8, () => { BIT(1, regs.D); })},
                { 0x4B, new Opcode(0x4B, "BIT 1, E",             2,  8, () => { BIT(1, regs.E); })},
                { 0x4C, new Opcode(0x4C, "BIT 1, H",             2,  8, () => { BIT(1, regs.H); })},
                { 0x4D, new Opcode(0x4D, "BIT 1, L",             2,  8, () => { BIT(1, regs.L); })},
                { 0x4E, new Opcode(0x4E, "BIT 1, (HL)",          2, 12, () => { BIT(1, mem.Read8(regs.HL)); })},
                { 0x4F, new Opcode(0x4F, "BIT 1, A",             2,  8, () => { BIT(1, regs.A); })},
                { 0x50, new Opcode(0x50, "BIT 2, B",             2,  8, () => { BIT(2, regs.B); })},
                { 0x51, new Opcode(0x51, "BIT 2, C",             2,  8, () => { BIT(2, regs.C); })},
                { 0x52, new Opcode(0x52, "BIT 2, D",             2,  8, () => { BIT(2, regs.D); })},
                { 0x53, new Opcode(0x53, "BIT 2, E",             2,  8, () => { BIT(2, regs.E); })},
                { 0x54, new Opcode(0x54, "BIT 2, H",             2,  8, () => { BIT(2, regs.H); })},
                { 0x55, new Opcode(0x55, "BIT 2, L",             2,  8, () => { BIT(2, regs.L); })},
                { 0x56, new Opcode(0x56, "BIT 2, (HL)",          2, 12, () => { BIT(2, mem.Read8(regs.HL)); })},
                { 0x57, new Opcode(0x57, "BIT 2, A",             2,  8, () => { BIT(2, regs.A); })},
                { 0x58, new Opcode(0x58, "BIT 3, B",             2,  8, () => { BIT(3, regs.B); })},
                { 0x59, new Opcode(0x59, "BIT 3, C",             2,  8, () => { BIT(3, regs.C); })},
                { 0x5A, new Opcode(0x5A, "BIT 3, D",             2,  8, () => { BIT(3, regs.D); })},
                { 0x5B, new Opcode(0x5B, "BIT 3, E",             2,  8, () => { BIT(3, regs.E); })},
                { 0x5C, new Opcode(0x5C, "BIT 3, H",             2,  8, () => { BIT(3, regs.H); })},
                { 0x5D, new Opcode(0x5D, "BIT 3, L",             2,  8, () => { BIT(3, regs.L); })},
                { 0x5E, new Opcode(0x5E, "BIT 3, (HL)",          2, 12, () => { BIT(3, mem.Read8(regs.HL)); })},
                { 0x5F, new Opcode(0x5F, "BIT 3, A",             2,  8, () => { BIT(3, regs.A); })},
                { 0x60, new Opcode(0x60, "BIT 4, B",             2,  8, () => { BIT(4, regs.B); })},
                { 0x61, new Opcode(0x61, "BIT 4, C",             2,  8, () => { BIT(4, regs.C); })},
                { 0x62, new Opcode(0x62, "BIT 4, D",             2,  8, () => { BIT(4, regs.D); })},
                { 0x63, new Opcode(0x63, "BIT 4, E",             2,  8, () => { BIT(4, regs.E); })},
                { 0x64, new Opcode(0x64, "BIT 4, H",             2,  8, () => { BIT(4, regs.H); })},
                { 0x65, new Opcode(0x65, "BIT 4, L",             2,  8, () => { BIT(4, regs.L); })},
                { 0x66, new Opcode(0x66, "BIT 4, (HL)",          2, 12, () => { BIT(4, mem.Read8(regs.HL)); })},
                { 0x67, new Opcode(0x67, "BIT 4, A",             2,  8, () => { BIT(4, regs.A); })},
                { 0x68, new Opcode(0x68, "BIT 5, B",             2,  8, () => { BIT(5, regs.B); })},
                { 0x69, new Opcode(0x69, "BIT 5, C",             2,  8, () => { BIT(5, regs.C); })},
                { 0x6A, new Opcode(0x6A, "BIT 5, D",             2,  8, () => { BIT(5, regs.D); })},
                { 0x6B, new Opcode(0x6B, "BIT 5, E",             2,  8, () => { BIT(5, regs.E); })},
                { 0x6C, new Opcode(0x6C, "BIT 5, H",             2,  8, () => { BIT(5, regs.H); })},
                { 0x6D, new Opcode(0x6D, "BIT 5, L",             2,  8, () => { BIT(5, regs.L); })},
                { 0x6E, new Opcode(0x6E, "BIT 5, (HL)",          2, 12, () => { BIT(5, mem.Read8(regs.HL)); })},
                { 0x6F, new Opcode(0x6F, "BIT 5, A",             2,  8, () => { BIT(5, regs.A); })},
                { 0x70, new Opcode(0x70, "BIT 6, B",             2,  8, () => { BIT(6, regs.B); })},
                { 0x71, new Opcode(0x71, "BIT 6, C",             2,  8, () => { BIT(6, regs.C); })},
                { 0x72, new Opcode(0x72, "BIT 6, D",             2,  8, () => { BIT(6, regs.D); })},
                { 0x73, new Opcode(0x73, "BIT 6, E",             2,  8, () => { BIT(6, regs.E); })},
                { 0x74, new Opcode(0x74, "BIT 6, H",             2,  8, () => { BIT(6, regs.H); })},
                { 0x75, new Opcode(0x75, "BIT 6, L",             2,  8, () => { BIT(6, regs.L); })},
                { 0x76, new Opcode(0x76, "BIT 6, (HL)",          2, 12, () => { BIT(6, mem.Read8(regs.HL)); })},
                { 0x77, new Opcode(0x77, "BIT 6, A",             2,  8, () => { BIT(6, regs.A); })},
                { 0x78, new Opcode(0x78, "BIT 7, B",             2,  8, () => { BIT(7, regs.B); })},
                { 0x79, new Opcode(0x79, "BIT 7, C",             2,  8, () => { BIT(7, regs.C); })},
                { 0x7A, new Opcode(0x7A, "BIT 7, D",             2,  8, () => { BIT(7, regs.D); })},
                { 0x7B, new Opcode(0x7B, "BIT 7, E",             2,  8, () => { BIT(7, regs.E); })},
                { 0x7C, new Opcode(0x7C, "BIT 7, H",             2,  8, () => { BIT(7, regs.H); })},
                { 0x7D, new Opcode(0x7D, "BIT 7, L",             2,  8, () => { BIT(7, regs.L); })},
                { 0x7E, new Opcode(0x7E, "BIT 7, (HL)",          2, 12, () => { BIT(7, mem.Read8(regs.HL)); })},
                { 0x7F, new Opcode(0x7F, "BIT 7, A",             2,  8, () => { BIT(7, regs.A); })},

                { 0x80, new Opcode(0x80, "RES 0, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x81, new Opcode(0x81, "RES 0, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x82, new Opcode(0x82, "RES 0, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x83, new Opcode(0x83, "RES 0, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x84, new Opcode(0x84, "RES 0, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x85, new Opcode(0x85, "RES 0, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x86, new Opcode(0x86, "RES 0, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0x87, new Opcode(0x87, "RES 0, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x88, new Opcode(0x88, "RES 1, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x89, new Opcode(0x89, "RES 1, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x8A, new Opcode(0x8A, "RES 1, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x8B, new Opcode(0x8B, "RES 1, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x8C, new Opcode(0x8C, "RES 1, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x8D, new Opcode(0x8D, "RES 1, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x8E, new Opcode(0x8E, "RES 1, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0x8F, new Opcode(0x8F, "RES 1, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x90, new Opcode(0x90, "RES 2, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x91, new Opcode(0x91, "RES 2, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x92, new Opcode(0x92, "RES 2, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x93, new Opcode(0x93, "RES 2, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x94, new Opcode(0x94, "RES 2, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x95, new Opcode(0x95, "RES 2, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x96, new Opcode(0x96, "RES 2, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0x97, new Opcode(0x97, "RES 2, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x98, new Opcode(0x98, "RES 3, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x99, new Opcode(0x99, "RES 3, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x9A, new Opcode(0x9A, "RES 3, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x9B, new Opcode(0x9B, "RES 3, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x9C, new Opcode(0x9C, "RES 3, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x9D, new Opcode(0x9D, "RES 3, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0x9E, new Opcode(0x9E, "RES 3, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0x9F, new Opcode(0x9F, "RES 3, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA0, new Opcode(0xA0, "RES 4, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA1, new Opcode(0xA1, "RES 4, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA2, new Opcode(0xA2, "RES 4, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA3, new Opcode(0xA3, "RES 4, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA4, new Opcode(0xA4, "RES 4, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA5, new Opcode(0xA5, "RES 4, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA6, new Opcode(0xA6, "RES 4, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xA7, new Opcode(0xA7, "RES 4, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA8, new Opcode(0xA8, "RES 5, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xA9, new Opcode(0xA9, "RES 5, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xAA, new Opcode(0xAA, "RES 5, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xAB, new Opcode(0xAB, "RES 5, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xAC, new Opcode(0xAC, "RES 5, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xAD, new Opcode(0xAD, "RES 5, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xAE, new Opcode(0xAE, "RES 5, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xAF, new Opcode(0xAF, "RES 5, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB0, new Opcode(0xB0, "RES 6, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB1, new Opcode(0xB1, "RES 6, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB2, new Opcode(0xB2, "RES 6, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB3, new Opcode(0xB3, "RES 6, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB4, new Opcode(0xB4, "RES 6, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB5, new Opcode(0xB5, "RES 6, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB6, new Opcode(0xB6, "RES 6, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xB7, new Opcode(0xB7, "RES 6, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB8, new Opcode(0xB8, "RES 7, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xB9, new Opcode(0xB9, "RES 7, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xBA, new Opcode(0xBA, "RES 7, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xBB, new Opcode(0xBB, "RES 7, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xBC, new Opcode(0xBC, "RES 7, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xBD, new Opcode(0xBD, "RES 7, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xBE, new Opcode(0xBE, "RES 7, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xBF, new Opcode(0xBF, "RES 7, A",             2,  8, () => { throw new NotImplementedException(); })},

                { 0xC0, new Opcode(0xC0, "SET 0, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC1, new Opcode(0xC1, "SET 0, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC2, new Opcode(0xC2, "SET 0, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC3, new Opcode(0xC3, "SET 0, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC4, new Opcode(0xC4, "SET 0, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC5, new Opcode(0xC5, "SET 0, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC6, new Opcode(0xC6, "SET 0, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xC7, new Opcode(0xC7, "SET 0, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC8, new Opcode(0xC8, "SET 1, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xC9, new Opcode(0xC9, "SET 1, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xCA, new Opcode(0xCA, "SET 1, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xCB, new Opcode(0xCB, "SET 1, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xCC, new Opcode(0xCC, "SET 1, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xCD, new Opcode(0xCD, "SET 1, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xCE, new Opcode(0xCE, "SET 1, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xCF, new Opcode(0xCF, "SET 1, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD0, new Opcode(0xD0, "SET 2, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD1, new Opcode(0xD1, "SET 2, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD2, new Opcode(0xD2, "SET 2, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD3, new Opcode(0xD3, "SET 2, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD4, new Opcode(0xD4, "SET 2, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD5, new Opcode(0xD5, "SET 2, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD6, new Opcode(0xD6, "SET 2, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xD7, new Opcode(0xD7, "SET 2, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD8, new Opcode(0xD8, "SET 3, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xD9, new Opcode(0xD9, "SET 3, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xDA, new Opcode(0xDA, "SET 3, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xDB, new Opcode(0xDB, "SET 3, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xDC, new Opcode(0xDC, "SET 3, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xDD, new Opcode(0xDD, "SET 3, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xDE, new Opcode(0xDE, "SET 3, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xDF, new Opcode(0xDF, "SET 3, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE0, new Opcode(0xE0, "SET 4, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE1, new Opcode(0xE1, "SET 4, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE2, new Opcode(0xE2, "SET 4, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE3, new Opcode(0xE3, "SET 4, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE4, new Opcode(0xE4, "SET 4, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE5, new Opcode(0xE5, "SET 4, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE6, new Opcode(0xE6, "SET 4, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xE7, new Opcode(0xE7, "SET 4, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE8, new Opcode(0xE8, "SET 5, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xE9, new Opcode(0xE9, "SET 5, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xEA, new Opcode(0xEA, "SET 5, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xEB, new Opcode(0xEB, "SET 5, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xEC, new Opcode(0xEC, "SET 5, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xED, new Opcode(0xED, "SET 5, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xEE, new Opcode(0xEE, "SET 5, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xEF, new Opcode(0xEF, "SET 5, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF0, new Opcode(0xF0, "SET 6, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF1, new Opcode(0xF1, "SET 6, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF2, new Opcode(0xF2, "SET 6, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF3, new Opcode(0xF3, "SET 6, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF4, new Opcode(0xF4, "SET 6, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF5, new Opcode(0xF5, "SET 6, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF6, new Opcode(0xF6, "SET 6, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xF7, new Opcode(0xF7, "SET 6, A",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF8, new Opcode(0xF8, "SET 7, B",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xF9, new Opcode(0xF9, "SET 7, C",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xFA, new Opcode(0xFA, "SET 7, D",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xFB, new Opcode(0xFB, "SET 7, E",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xFC, new Opcode(0xFC, "SET 7, H",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xFD, new Opcode(0xFD, "SET 7, L",             2,  8, () => { throw new NotImplementedException(); })},
                { 0xFE, new Opcode(0xFE, "SET 7, (HL)",          2, 16, () => { throw new NotImplementedException(); })},
                { 0xFF, new Opcode(0xFF, "SET 7, A",             2,  8, () => { throw new NotImplementedException(); })},
            };
        }
