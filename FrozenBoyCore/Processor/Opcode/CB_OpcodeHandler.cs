    ...
    public class CB_OpcodeHandler {
        ...
        private Dictionary<u8, Opcode> InitializeCB() {
            return new Dictionary<u8, Opcode> {              
                ...
                { 0x06, new Opcode(0x06, "RLC (HL)",             2, 16, [
                ...
                { 0x0E, new Opcode(0x0E, "RRC (HL)",             2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
                ...
                { 0x16, new Opcode(0x16, "RL (HL)",              2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
                ...
                { 0x1E, new Opcode(0x1E, "RR (HL)",              2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
                ...
                { 0x26, new Opcode(0x26, "SLA (HL)",             2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
                ...
                { 0x2E, new Opcode(0x2E, "SRA (HL)",             2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
                ...
                { 0x36, new Opcode(0x36, "SWAP (HL)",            2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
                ...
                { 0x3E, new Opcode(0x3E, "SRL (HL)",             2, 16, [
                                                                             () => { operand = mmu.Read8(regs.HL); },
        ...
        // Set bit in value
        private static byte SET(u8 value, int bitPosition) {
            return (u8)(value | (0b_0000_0001 << bitPosition));
        }

        // Reset bit in value
        private static byte RES(u8 value, int bitPosition) {
